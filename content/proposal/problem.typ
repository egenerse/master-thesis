...
Several factors may contribute to this problem. First, Apollon’s user interface might not be intuitive or accessible enough, which can lead to confusion and frustration for new users @Intechnic2023. Some students may find it challenging to discover and understand where all the features are located, especially when compared to alternative tools that they are more familiar with @Ferreira2024. Additionally, usability bugs in the interface can further discourage students from using the tool, as they may find it inconvenient or unreliable for their diagramming needs.

Moreover, with the increasing use of iPads for educational purposes, students have grown accustomed to the portability and intuitive touch interfaces that these devices offer, which are well-suited for tasks such as diagram creation. However, Apollon does not currently support a tailored experience for iPad users, potentially alienating this user base who might find using an adapted tool more convenient and engaging for their educational needs. A study documented by Smith and Gonzalez in the International Journal of Mobile Learning and Organisation supports this viewpoint, highlighting how iPads can significantly enhance learning experiences. Their research indicates that iPads not only increase student engagement but also improve the efficiency of learning activities like diagram creation, which are essential in technical education @iPadEdu2024.
