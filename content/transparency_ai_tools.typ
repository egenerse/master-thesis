...
In preparing this thesis, we utilized Grammarly for grammar and style correction across the Abstract, Introduction, and Conclusion sections, ensuring clarity and coherence in our writing. We used ChatGPT to generate initial drafts and expand on ideas in the thesis sections, providing valuable suggestions and examples. Additionally, we used GitHub Copilot to generate code snippets for the developed functionality and code snippets while developing. We have carefully checked all texts created with these tools to ensure that they are correct and make sense.